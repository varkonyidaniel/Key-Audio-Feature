...
# MEGÍRNI
    ...
    # bemenő paramétereket megírni hozzá!!!
    #TODO: feldolgozásokat is megírni!!!
    def eval_population(self, num_gen:int):
        ...
        # EZ A SOR AKKOR HAJTÓDIK VÉGRE, AMIKOR AZ ÖSSZES KIÉRTÉKELÉS BEFEJEZŐDÖTT!!!
        # EREDFMÉNYEK A "result_dict" változóban!!!!

        # ... innen logok feldolgozás jön!!!!
        # --output=./logs/log_job_node_3_generation_2_individual_100_regressor_decision_tree.out"
